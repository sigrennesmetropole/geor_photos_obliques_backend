 ...
 */
@Repository
public class RoleCustomRepositoryImpl extends AbstractCustomRepositoryImpl<RoleEntity, RolePhotosObliquesCriteria> implements RoleCustomRepository {
	...
	public RoleCustomRepositoryImpl(EntityManager entityManager) {
		super(entityManager, RoleEntity.class);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED, readOnly = true)
	public List<RoleEntity> searchRoles(RolePhotosObliquesCriteria searchCriteria) {
		...
		TypedQuery<RoleEntity> typedQuery = getEntityManager().createQuery(searchQuery);
		return typedQuery.getResultList();
	}

	private void buildQuery(RolePhotosObliquesCriteria searchCriteria, CriteriaBuilder builder, CriteriaQuery<?> criteriaQuery,
