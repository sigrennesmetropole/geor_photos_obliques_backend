...
@SuperBuilder
@ToString
public abstract class AbstractRestrictedAuditablePhotosObliquesCriteria extends AbstractAuditablePhotosObliquesCriteria
		implements RestrictedPhotosObliquesCriteria {
